 ...
 *
 * SIDEN FINDES FOR GENBESTILLINGEN. Har butikken betalt for en egen frontfarve,
 * skal de kunne bestille flere uden at betale for opsætningen igen, og uden at
 * skulle finde logoet og farvekoden frem en gang til.
 */
export default async function DesignPage() {
  ...
  return (
    <>
      <PageHeader
        title="Design"
        description="Dine trykvalg — farve, front og logo. Bestil flere af et design, du allerede har."
      />
      ...
      {designs && designs.length ? (
        ...
        <EmptyState
          icon={StandIcon}
          title="Ingen design endnu"
          description="Dit design bliver gemt automatisk, første gang du bestiller en stander med logo og farve. Bagefter kan du bestille flere af det uden at vælge forfra — og uden at betale for farven igen."
        />
      )}
    </>
  );
