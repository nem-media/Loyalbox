        ...
        <section aria-labelledby="varer">
          ...
          >
            {PRODUKT_FOTO[p.slug] ? (
              ...
              /* PLADSHOLDEREN SKAL TEGNE VAREN OG IKKE KATEGORIEN. En vare
                 uden fysisk skilt får QR-feltet: standerikonet ville vise et
                 skilt med fod under overskriften "uden fysisk stander", og
                 "Foto på vej" ville love et billede, der aldrig kommer. */
              (() => {
