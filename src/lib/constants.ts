...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description:
      "Standeren med LoyalBox review-platformen oveni. Et smart review-flow sender glade kunder direkte til Google, mens kritik lander privat i dit dashboard — så en enkelt dårlig oplevelse ikke bliver en offentlig 1-stjerne. Skift destination når som helst med dynamiske links, og følg det hele i realtid.",
    image: "/mockups/stander-alt-i-en-komplet.svg",
    features: [
      "Smart review-flow (glade → offentlig, kritik → privat)",
      "Dynamiske links — skift destination når som helst",
